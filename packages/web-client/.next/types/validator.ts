...
// Validate ../../src/app/api/monster/route.tsx
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/monster">> = Specific
  const handler = {} as typeof import("../../src/app/api/monster/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
